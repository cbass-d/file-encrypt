...
mod encryption_tests {
    ...
    fn test_aes256_gcm() {
        ...
        match encryption_algos::aes256_gcm::decrypt_file(
            file,
            passphrase,
            argon_pch,
            out_file.clone(),
    ...
    fn test_chacha20() {
        ...
        match encryption_algos::chacha20_poly::encrypt_file(
            file,
            passphrase.clone(),
            out_file.clone(),
        ) {
